...
Generated-kernel records include the exact `fortsym` revision, `-O3` compiler
flags, post-CSE structural operation counts, and release native symbol sizes.
The current generated arithmetic matches the arithmetic used for the committed
timings.
