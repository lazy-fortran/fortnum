...
- optional reuse of the converged analytical vector-root Jacobian and its LU
  factorization across JVP directions
...
| roots and fixed points | analytical boundaries, scalar/vector hybrid JVP/VJP, converged-Jacobian reuse, and JVP factor reuse complete; VJP factor reuse and tournament pending | complete-solve finite-difference, Jacobian, and scalar-objective oracles |
