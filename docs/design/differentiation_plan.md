...
| ODE hybridization | forward sensitivity with Enzyme RHS JVP and analytical Cash-Karp discrete adjoint complete; parameter adjoint and broader tournaments pending | closed-form trajectory sensitivity, exact matrix-exponential VJP, adjoint identity, and complete-solve finite difference |
