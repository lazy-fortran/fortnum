...
| interpolation interface rules | combined evaluation/value, active support nodes and breakpoints, implicit fitted coefficients, and cell/span crossing status complete | finite-difference directional, adjoint, and fixed-grid tests |
