...
- hybrid vector-root JVP and VJP candidates using Enzyme forward and reverse
  residual products
- optional reuse of the converged analytical vector-root Jacobian
...
| roots and fixed points | analytical boundaries, scalar/vector hybrid JVP/VJP, and converged-Jacobian reuse complete; factorization reuse and tournament pending | complete-solve finite-difference, Jacobian, and scalar-objective oracles |
