...
| interpolation interface rules | combined evaluation/value, active support nodes and breakpoints, implicit fitted coefficients, cell/span status, and Lagrange interface tournament complete | finite-difference directional, adjoint, fixed-grid, and scaling evidence |
