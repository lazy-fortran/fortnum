...
| ODE hybridization | forward sensitivity with Enzyme RHS JVP, analytical Cash-Karp discrete adjoint, stage-level parameter VJP accumulation, checkpointed/recomputed reverse, and batched analytical implicit-stage tangents complete; implicit-stage adjoints and broader tournaments pending | closed-form trajectory sensitivity, exact matrix-exponential VJP, exact implicit-stage tangent, parameter/direction/checkpoint scaling, adjoint identity, and complete-solve finite difference |
