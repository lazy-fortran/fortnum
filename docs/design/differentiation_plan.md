...
| linear algebra | determinant JVP and implicit solve JVP/VJP with factorization reuse complete | finite-difference, adjoint, scaling, cache, memory, and reuse benchmarks |
