...
| integration | fixed/moving-bound analytical JVPs, fixed-quadrature hybrid JVP/VJP, and analytical/autodiff/hybrid frozen-trace adaptive JVP candidates complete; full workload tournaments pending | closed-form integral and Leibniz derivatives, frozen-trace finite differences, and trace-change checks |
