...
| integration | fixed/moving-bound analytical JVPs, complete fixed-quadrature JVP/VJP tournament, and analytical/autodiff/hybrid frozen-trace adaptive JVP candidates complete; adaptive workload tournaments pending | closed-form integral and Leibniz derivatives, frozen-trace finite differences, and trace-change checks |
