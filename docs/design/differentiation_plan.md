...
| roots and fixed points | scalar tournament complete; analytical boundaries, scalar/vector hybrid JVP/VJP, Jacobian/factor reuse, and implicit JVP/VJP reliability complete; vector tournament pending | complete-solve finite-difference, exact-condition, Jacobian, and scalar-objective oracles |
