...
| integration | fixed/moving-bound analytical JVPs, Enzyme-integrand/analytical-quadrature hybrid JVP/VJP, and analytical plus forward-autodiff frozen-trace adaptive JVP candidates complete; hybrid adaptive candidates and full tournaments pending | closed-form integral and Leibniz derivatives, frozen-trace finite differences, and trace-change checks |
