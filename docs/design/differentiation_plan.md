...
| symbolic generation | one-DAG value, contracted JVP/VJP, fused/separate Dawson family, and annotation-only device-leaf emission complete | `gen_dawson_outer`, independent finite-difference and adjoint oracles, regeneration gate, OpenMP compile oracle, fused/separate benchmark |
