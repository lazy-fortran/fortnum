...
| symbolic generation | one-DAG value, contracted JVP/VJP, and fused/separate Dawson family complete | `gen_dawson_outer`, independent finite-difference and adjoint oracles, regeneration gate, fused/separate benchmark |
