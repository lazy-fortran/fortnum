! Copied from tools/fortad/dot_sin_kernel.f90 by tools/fortad/generate.sh.
! It is compiled into the library so the testbed's derivative kernels have a
! primal to be checked against. Edit the original, not this.
