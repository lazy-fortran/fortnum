...
- [ ] Add a generic analytical implicit tangent boundary for scalar roots.
- [ ] Add a generic analytical implicit adjoint boundary for scalar roots.
- [ ] Add a generic analytical implicit tangent boundary for vector roots.
...
- [ ] Add an autodiff frozen-trace adaptive-integration candidate.
...
- [ ] Add hybrid forward sensitivities using autodiff RHS JVPs.
- [ ] Add an analytical discrete adjoint for one explicit ODE method.
